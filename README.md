...
| Async and concurrency  | `add_string_dataset_record_async`, `add_trades_parallel`                          | Running the synchronous API client in worker threads with one client per worker                           |
