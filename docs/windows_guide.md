...
2. **Install dependencies**: The `vbase-py-samples` project comes with its `requirements/lock/win.txt`. This installs the required pre-built packages available for Windows:
